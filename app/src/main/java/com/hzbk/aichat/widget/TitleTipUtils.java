...
public class TitleTipUtils {
    ...
    public static void titleTipUtils(Context context, TextView textView, String tip, String result, float tipTextSize, int resultTextSize, int radius) {
        ...
        //构造文字背景圆角
        RadiusBackgroundSpan span = new RadiusBackgroundSpan(context.getResources().getColor(R.color.color_FFF1EB)
                , context.getResources().getColor(R.color.color_FFFF8632), radius, (int) spToPixels(context, resultTextSize));
