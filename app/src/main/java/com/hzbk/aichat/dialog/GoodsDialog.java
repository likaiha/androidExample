 ...
 *gz
 */
public class GoodsDialog extends AppCompatDialog {
    ...
    public GoodsDialog(Context context, int style) {
        super(context, style);
    ...
    public GoodsDialog applyStyle(int styleId) {
    ...
    public GoodsDialog cancelable(boolean cancelable){
        super.setCancelable(cancelable);
        mCancelable = cancelable;
        return this;
    }

    public GoodsDialog canceledOnTouchOutside(boolean cancel){
     ...
     */
    public GoodsDialog contentView(View v){
        mContentView = v;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsDialog contentView(int layoutId){
        if(layoutId == 0)
            return this;
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsDialog heightParam(int height){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsDialog inDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsDialog inInterpolator(Interpolator interpolator){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsDialog outDuration(int duration){
     ...
     * @return The BottomSheetDialog for chaining methods.
     */
    public GoodsDialog outInterpolator(Interpolator interpolator){
