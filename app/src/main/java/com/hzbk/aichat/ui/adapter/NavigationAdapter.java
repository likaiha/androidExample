...
import com.hzbk.aichat.app.AppAdapter;
import com.hzbk.aichat.app.base.BaseAdapter;
...
public final class NavigationAdapter extends AppAdapter<NavigationAdapter.MenuItem>
    ...
    private final class ViewHolder extends BaseAdapter.ViewHolder {
        ...
        private ViewHolder() {
            ...
            mIconView = (ImageView) findViewById(R.id.iv_home_navigation_icon);
            mTitleView = (TextView) findViewById(R.id.tv_home_navigation_title);
        }
