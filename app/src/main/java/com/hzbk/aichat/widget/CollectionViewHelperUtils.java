...
public class CollectionViewHelperUtils {
    ...
    public static VaryViewHelper getViewHelper(Context context, View contentView, View.OnClickListener onClickListener) {
        return new VaryViewHelper.Builder()
                ...
                .setEmptyView(LayoutInflater.from(context).inflate(R.layout.base_layout_collerction_empty_view, new LinearLayout(context), false))//空页面，无实际逻辑处理
