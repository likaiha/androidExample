package com.hzbk.aichat.manager;
        ...
        if (mActivitySet.size() == 0) {
            for (ApplicationLifecycleCallback callback : mLifecycleCallbacks) {
                callback.onApplicationCreate(activity);
                  ...
                  LogUtils.i("%s - onApplicationCreate", activity.getClass().getSimpleName());
        }
        ...
        if (mTopActivity == activity && mResumedActivity == null) {
            for (ApplicationLifecycleCallback callback : mLifecycleCallbacks) {
                callback.onApplicationForeground(activity);
                  ...
                  LogUtils.i("%s - onApplicationForeground", activity.getClass().getSimpleName());
        }
        mTopActivity = activity;
        ...
        if (mResumedActivity == null) {
            for (ApplicationLifecycleCallback callback : mLifecycleCallbacks) {
                callback.onApplicationBackground(activity);
                  ...
                  LogUtils.i("%s - onApplicationBackground", activity.getClass().getSimpleName());
        }
    }
        ...
        if (mActivitySet.size() == 0) {
            for (ApplicationLifecycleCallback callback : mLifecycleCallbacks) {
                callback.onApplicationDestroy(activity);
                  ...
                  LogUtils.i("%s - onApplicationDestroy", activity.getClass().getSimpleName());
        }
    }
