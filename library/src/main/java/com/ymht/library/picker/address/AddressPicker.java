...
public class AddressPicker extends Dialog implements View.OnClickListener {
    ...
    private ArrayList<AddressBean> cityList = new ArrayList<>();
    private ArrayList<AddressBean> districtList = new ArrayList<>();
    private ArrayList<AddressBean> streetList = new ArrayList<>();

    private ArrayList<TextView> textViewArrayList = new ArrayList<>();

    private int tabSelectedColor = Color.parseColor("#AE2B2B");//tab选择的颜色
    private int tabUnselectedColor = Color.parseColor("#000000");//tab未选择的颜色
    private int indicatorColor = Color.parseColor("#AE2B2B");//指示器的颜色
    private int itemTextSelectedColor = Color.parseColor("#AE2B2B");//item的text选中的颜色
    ...
    public void provinceSuccess(ArrayList<AddressBean> list) {
    ...
    public void citySuccess(ArrayList<AddressBean> list) {
        cityList.clear();
    ...
    public void districtSuccess(ArrayList<AddressBean> list) {
        districtList.clear();
    ...
    public void streetSuccess(ArrayList<AddressBean> list) {
        streetList.clear();
