 ...
 */
public class MyRefreshHeaderf1f1 extends LinearLayout implements RefreshHeader {
    ...
    public MyRefreshHeaderf1f1(Context context) {
        super(context);
        initView(context);
    }


    public MyRefreshHeaderf1f1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public MyRefreshHeaderf1f1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
